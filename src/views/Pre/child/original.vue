  ...
  <div>
        ...
        <div class="left-block">
          ...
          <div class="fl">
            ...
            <select name="agreement">
              <option value="全部">全部</option>
              <option value="是">转换成功</option>
              <option value="否">转换异常</option>
            </select>
          </div>
          <div class="fl">
            <span>关键字</span>
            <input type="text" placeholder="患者姓名/手机号/医院处方ID" />
          </div>
    ...
    <div class="box">
      ...
      >
        ...
        <el-table-column label="医院处方ID" width="110" prop="id"></el-table-column>
        ...
        <el-table-column prop="state" label="处方状态" width="120" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column prop="dose" label="剂量" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column prop="remarks" label="医院备注" show-overflow-tooltip ></el-table-column>
      </el-table>
    </div>
  </div>
</template>
